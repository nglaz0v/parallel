#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# https://rosettacode.org/wiki/Checkpoint_synchronization#Python
"""
...
def worker(workernum, barrier):
    ...
    print('Starting worker ' + str(workernum) +
          " task 1, sleeptime=" + str(sleeptime))
    ...
    sleeptime = random.random()
    print('Starting worker ' + str(workernum) +
          " task 2, sleeptime=" + str(sleeptime))
    time.sleep(sleeptime)
    print('Exiting worker'+str(workernum))
